...
using AzureBlobStorageWebAPI.API.SeedWork.CustomProblemDetails;
using AzureBlobStorageWebAPI.Application.SeedWork.CustomExceptions;
using System;
...
namespace AzureBlobStorageWebAPI.API.CustomMiddlewares
{
        ...
        private ProblemDetails GetProblemDetails(Exception ex)
        {
            ...
            else
            {
                return new ProblemDetails
                {
                    ...
                    Detail = @"We apologize for inconvenience. Please let us know about the error at support@AzureBlobStorageWebAPI.com. Include traceId: {traceId} in email",
                    Instance = traceId
                };
            }
        }
